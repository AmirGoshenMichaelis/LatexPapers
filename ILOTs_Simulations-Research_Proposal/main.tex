...
\documentclass[a4paper,modern]{aastex62}
...
%by residing \emph{below} the OTS.
...
%
% This class \tred{include FU~Ori outbursts} \tred{I think FU Ori are regular outbursts--am I right. 
% Do you mean:
% "includes extreme FU Ori outbursts. 
% People see many outbursts of YSOs, so I am really not sure why you argue that all of these are planet destructions. 
% It is not clear here what you mean.  } \citep{2014prpl.conf..387A} witch are pre-MS starts \citep{1966VA......8..109H,1977ApJ...217..693H} that experience an extreme change in magnitude with slow (years) decline and spectral type. 
% FUor more energetic counterparts are the EXor class of outburst \cite{1989ESOC...33..233H} for witch EX Lupis as a prototype \cite{2007AJ....133.2679H}. 
% A pre-MS variables that show flares of a few months to a few years and of several magnitudes of amplitude as a result of episodic mass accretion. 
% Another transient ASASSN-13db \citep{2017A&A...607A.127S} may also be a related object.
%
